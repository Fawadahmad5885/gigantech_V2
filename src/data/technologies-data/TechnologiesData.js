import selenium from "../../../public/assets/images/technologies-images/qa.selenium.png";
import jenkins from "../../../public/assets/images/technologies-images/qa.jenkins.png";
import manualTesting from "../../../public/assets/images/technologies-images/qa.manualtesting.png";
...
export const TechnologiesData = [
  {
    ...
    tools: [
      { name: "Python", tooltip: "Core AI language", image: pythonImage },
      {
        name: "FastAPI",
        tooltip: "High-performance API framework",
        image: fastApiImage,
      },
      {
        name: "TensorFlow",
        tooltip: "Google ML framework",
        image: tensorFlowImage,
      },
      { name: "Keras", tooltip: "High-level NN API", image: kerasImage },
      { name: "PyTorch", tooltip: "Facebook ML library", image: pytorchImage },
      { name: "Scikit", tooltip: "Classical ML library", image: scikitImage },
      {
        name: "Matplotlib",
        tooltip: "Plotting library",
        image: MatplotlibImage,
      },
      { name: "Milvus", tooltip: "Scalable vector DB", image: MilvusIImage },
      { name: "Pinecone", tooltip: "Managed vector DB", image: PineconeImage },
      {
        name: "Weaviate",
        tooltip: "Hybrid vector search",
        image: WeaviateImage,
      },
      { name: "ChromaDB", tooltip: "Embedding database", image: ChromaDBImage },
      {
        name: "LangChain",
        tooltip: "LLM app framework",
        image: longChainImage,
      },
      {
        name: "OpenCV",
        tooltip: "Computer vision library",
        image: opencvImage,
      },
      { name: "VLM", tooltip: "Vision-language model", image: VLMIMage },
      {
        name: "OCR",
        tooltip: "Optical character recognition",
        image: ocrImage,
      },
      { name: "TTS", tooltip: "Text-to-speech", image: ttsImage },
      { name: "NLP", tooltip: "Natural language processing", image: nlpImage },
      {
        name: "Hugging Face",
        tooltip: "ML model hub",
        image: huggingFaceImage,
      },
      { name: "OpenAI", tooltip: "Models by OpenAI", image: openAiImage },
      { name: "LLaMA", tooltip: "Models by Meta", image: LLamaImage },
      { name: "DeepSeek", tooltip: "Models by DeepSeek", image: DeepSeekImage },
      { name: "Gemini", tooltip: "Models by Google", image: GeminiImage },
      { name: "Qwen", tooltip: "Models by AliBaba", image: Qwen },

      { name: "Claude", tooltip: "models by Anthropic", image: claudeImage },
      {
        name: "PE",
        tooltip: "LLM prompt engineering",
        image: PromptEngImage,
      },
      {
        name: "RAG",
      ...
      {
        name: "Transformers",
        tooltip: "Library for NLP transformer models",
        image: transformerImage,
      },
      {
        name: "LlamaIndex",
        tooltip: "Data retrieval framework",
        image: LlamaIndexImage,
      },
      {
        name: "Ollama",
        tooltip: "Running open-source LLMs locally",
        image: OllamaImage,
      },
    ],
  },

  {
    ...
    tools: [
      ...
      { name: "React", tooltip: "Frontend library for UI", image: ReactImage },
      {
        name: "NextJS",
        tooltip: "React framework for SSR",
        image: NextJSImage,
      },
      { name: "MUI", tooltip: "Material-UI for React", image: MuiImage },
      {
        name: "Tailwind CSS",
      ...
      {
        name: "NestJS",
        tooltip: "Progressive Node.js framework",
        image: NestJSImage,
      },
      {
        name: "Loopback io",
        tooltip: "API framework for Node.js",
        image: LoopbackImage,
      },
      {
        name: "Express JS",
      ...
      {
        name: "Django",
        tooltip: "Web framework for Python",
        image: DjangoImage,
      },
      {
        name: "Flask",
        tooltip: "Lightweight Python web framework",
        image: FlaskImage,
      },
      { name: "MongoDB", tooltip: "NoSQL database", image: MongoDBImage },
      { name: "PostgreSQL", tooltip: "Relational database", image: PostgreSQL },
      { name: "MySQL", tooltip: "Popular relational database", image: MySQL },
      { name: "Redis", tooltip: "In-memory data store", image: Redis },
      {
        name: "Memcached",
        tooltip: "Distributed memory caching system",
  ...
  },
  {
    ...
    tools: [
      {
        name: "Android",
        tooltip: "Google's mobile operating system",
        image: androidImage,
      },
      {
        name: "iOS",
        tooltip: "Apple's mobile operating system",
        image: iosImage,
      },
      {
        name: "SwiftUI",
        tooltip: "Declarative UI framework for Apple platforms",
        image: swiftUiImage,
      },
      {
        name: "Storyboard",
        tooltip: "Interface builder for iOS apps",
        image: Storyboard,
      },
      {
        name: "Java",
        tooltip: "Popular programming language for Android development",
        image: JavaImage,
      },
      {
        name: "Kotlin",
        tooltip: "Modern programming language for Android development",
        image: kotlinImage,
      },
      { name: "MAUI", tooltip: ".NET Multi-platform App UI", image: mauiImage },
      {
        name: "React Native",
        tooltip: "Cross-platform framework for mobile apps",
  ...
  },
  {
    ...
    tools: [
      ...
      {
        name: "C++",
        tooltip: "Object-oriented programming language for systems programming",
        image: CppImage,
      },
      {
        name: "ARM",
        tooltip: "Advanced RISC Machine architecture",
        image: ARMImage,
      },
      {
        name: "Microchip",
        tooltip: "Microcontroller solutions provider",
        image: MicroChipImage,
      },
      {
        name: "Renesas",
        tooltip: "Manufacturer of semiconductors",
        image: RenesasImage,
      },
      {
        name: "SiLabs",
        tooltip: "Silicon Labs - IoT solutions",
        image: SiLabsImage,
      },
      {
        name: "STM",
        tooltip: "STMicroelectronics - semiconductor solutions",
        image: STMImage,
      },
      {
        name: "Beaglebone",
        tooltip: "Low-power open-source single-board computer",
        image: BeagleboneImage,
      },
      {
        name: "Motorolla",
        tooltip: "Telecommunication and embedded solutions provider",
        image: MotorolaImage,
      },
      {
        name: "Raspberry Pi",
        tooltip: "Small and affordable computer for learning",
        image: RaspberryImage,
      },
      {
        name: "Arduino",
        tooltip: "Open-source electronics platform",
        image: ArduinoImage,
      },
      { name: "BLE", tooltip: "Bluetooth Low Energy for IoT", image: BLEImage },
      {
        name: "ZigBee",
        tooltip: "Wireless technology for IoT",
        image: ZigbeeImage,
      },
      // { name: "XBee", tooltip: "Wireless communication modules", image: "https://example.com/xbee.png" },
      {
        name: "Radar",
        tooltip: "Radio detection and ranging system",
        image: radarImage,
      },
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        name: "Ansible",
        tooltip:
          "Agentless automation tool for configuration management and orchestration",
      },
      {
      ...
      },
      {
        image: AzurImage,
        name: "Azure",
        tooltip: "Microsoft Azure DevOps",
      },
      {
        image: AWSImage,
        name: "AWS",
